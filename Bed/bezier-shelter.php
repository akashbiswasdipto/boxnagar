...
<div class="row">
    <div class="column left">
        <div class="w3-content">
            <div class="imgcon">
                ...
                <img class="mySlides" src="img/prod-2/2.jpg" style=" padding-left:7%;">
            ...
            <div class="w3-row-padding w3-section" style="text-align: center" >
                ...
                <div class="w3-col s4">
                    <img class="demo w3-opacity w3-hover-opacity-off" src="img/prod-2/2.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(2)">
                </div>
                <div class="w3-col s4">
    ...
    <div class="column right">
        <h1 style="font-size: 9vh;">BEZIER SHELTER BED</h1>
        <p>Dimension: </p>
        <p>Queen Bed: 66"W x 85½"L</p>
        <p>King Bed: 82"W x 85½"L</p>
        <br>
        <div class="text">
            <p>Designed by the Van Thiels, our collection's bold proportions are a striking counterpoint to the naturally rich grain of American white oak. Inspired by 1970s postmodern design, the silhouette's clean lines offer a style both rustic and refined.</p>
        </div>
        <br>
        <h4>45,000 Tk.</h4>
